 ...
 * {@link IoHandlerTransition} and {@link IoHandlerTransitions} annotations 
...
public class IoHandlerStateMachineFactory {
    ...
    public static StateMachine create(String start, Object handler, Object... handlers) {
        return StateMachineFactory.create(IoHandlerTransition.class, IoHandlerTransitions.class, start, handler, handlers);
    }
